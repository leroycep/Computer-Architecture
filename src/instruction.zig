...
pub const Instruction = enum(u8) {
    ...
    pub fn decode(val: u8) !@This() {
        return switch (val) {
            ...
            @enumToInt(@This().SUB) => .SUB,
            @enumToInt(@This().DIV) => .DIV,
            @enumToInt(@This().MUL) => .MUL,
            @enumToInt(@This().MOD) => .MOD,
            @enumToInt(@This().AND) => .AND,
            @enumToInt(@This().NOT) => .NOT,
            @enumToInt(@This().OR) => .OR,
            @enumToInt(@This().XOR) => .XOR,
            @enumToInt(@This().SHL) => .SHL,
            @enumToInt(@This().SHR) => .SHR,
            ...
            @enumToInt(@This().JGE) => .JGE,
            @enumToInt(@This().JGT) => .JGT,
            @enumToInt(@This().JLE) => .JLE,
            @enumToInt(@This().JLT) => .JLT,
